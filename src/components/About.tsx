    ...
    <div id="about" className="w-full flex flex-col items-center mt-12 gap-3">
      ...
      <div className="max-w-[1100px] font-light text-lg md:text-xl py-5 px-10 leading-relaxed text-justify text-secondary">
        <p>
          ...
          equipamentos modernos. Depilação a Laser, Power Shape, Vibrocell,
          Manthus, Carbox, Peeling Diamante e Limpeza de Pele, Massagens
          (Modeladora, Relaxante, Drenagem Linfática), Acupuntura,
          Microagulhamento, Designer de Sobrancelhas, Micropigmentação
          (Sobrancelhas, Lábios Aquarela e Delineador Artístico), Botox,
          Preenchimento e Aplicação de Enzimas.
        </p>
      </div>
    </div>
  )
